...
Envisioning failure doesn't mean that you must recognize failure as an acceptable outcome. Knowing what failure looks like merely allows the use signposts on the path of life, to serve as warnings that it's time for a course correction.||
